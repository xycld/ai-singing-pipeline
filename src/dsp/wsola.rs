/// Time-stretch mono audio according to anchor-point pairs `(source_sample, target_sample)`.
...
fn wsola_stretch(input: &[f64], ratio: f64) -> Vec<f64> {
    ...
    while out_pos + window_size <= output_len {
        ...
        // Cross-correlate against existing output for phase continuity

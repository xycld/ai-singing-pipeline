//! Feed-forward digital compressor (Giannoulis et al. 2012).
//!
//! Log-domain envelope follower with soft-knee static characteristic.
...
impl Compressor {
    ...
    /// Static gain characteristic: how much gain reduction to apply at level x_db.
